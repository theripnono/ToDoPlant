...
.start-button {
    ...
    font-size: 24px;
    padding: 1rem 2rem;
    text-decoration: none; /* Esto oculta el subrayado */
    border: none;
    border-radius: 20px;
    cursor: pointer;
}
...
@keyframes fadeIn {
    to {
        opacity: 1; /* Cambia la opacidad a 1 para hacer el botón visible */
    }
}
...
.container {
    ...
    justify-content: space-around; /* Añadido para centrar las tarjetas */
    align-items: center;
    height: 100vh;
}
